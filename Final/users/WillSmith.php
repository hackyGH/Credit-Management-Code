<?php
 ...
 <div class="container">
   <form action="WillSmith.php" method="post">
        <div class="form-group">
          <div>
            <label for="Name" class="form-control">Username:</label>
            <input class="form-control" type="text" name="user" value="<?php echo $WillSmith['Name'] ?>" placeholder="<?php echo $WillSmith['Name']; ?>" disabled> <br/>
            <label for="E-mail" class="form-control">Email:</label>
            <input class="form-control" type="text" name="E-mail" value="<?php echo $WillSmith['E-mail']; ?>" placeholder="<?php echo $WillSmith['E-mail']; ?>" disabled><br/>
            <label for="Credit" class="form-control">Current Credit:</label>
            <input type="text" name="currentcredit" value="<?php echo $WillSmith['Credit']; ?>" class="form-control" placeholder="<?php echo $WillSmith['Credit']; ?>" disabled><br/>
            <label for="transfer" class="form-control">How much credit you want to transfer from <?php echo $WillSmith['Name']; ?>?</label>
    ...
    if (isset($_POST['transfer'])) {
      ...
      if (mysqli_num_rows($r) < 1) {
        ...
        <script type="text/javascript">
          ...
          window.open("WillSmith.php", "_self");
        </script>
        <?php
      }
      $s = mysqli_fetch_assoc($r);
      $t = (int)$WillSmith['Credit'];
      if ($t < $_POST['Credit']) {
        ?>
          <script type="text/javascript">
        ...
        $x = " UPDATE `name` SET `Credit`= $transfered WHERE `Name` = 'WillSmith' ";
