<?php
 ...
 <div class="container">
   <form action="BradPitt.php" method="post">
        <div class="form-group">
          <div>
            <label for="Name" class="form-control">Username:</label>
            <input class="form-control" type="text" name="user" value="<?php echo $BradPitt['Name'] ?>" placeholder="<?php echo $BradPitt['Name']; ?>" disabled> <br/>
            <label for="E-mail" class="form-control">Email:</label>
            <input class="form-control" type="text" name="E-mail" value="<?php echo $BradPitt['E-mail']; ?>" placeholder="<?php echo $BradPitt['E-mail']; ?>" disabled><br/>
            <label for="Credit" class="form-control">Current Credit:</label>
            <input type="text" name="currentcredit" value="<?php echo $BradPitt['Credit']; ?>" class="form-control" placeholder="<?php echo $BradPitt['Credit']; ?>" disabled><br/>
            <label for="transfer" class="form-control">How much credit you want to transfer from <?php echo $BradPitt['Name']; ?>?</label>
    ...
    if (isset($_POST['transfer'])) {
      ...
      if (mysqli_num_rows($r) < 1) {
        ...
        <script type="text/javascript">
          ...
          window.open("BradPitt.php", "_self");
        </script>
        <?php
      }
      $s = mysqli_fetch_assoc($r);
      $t = (int)$BradPitt['Credit'];
      if ($t < $_POST['Credit']) {
        ?>
          <script type="text/javascript">
        ...
        $x = " UPDATE `name` SET `Credit`= $transfered WHERE `Name` = 'BradPitt' ";
